...
def appCompressionImg():
    ...
    MAIN_WINDOW.iconbitmap("./logo_compression_images_ico.ico")
    ...
    image = PhotoImage(file="logo_alligator_news.png").zoom(2).subsample(17)
    ...
    image2 = PhotoImage(file="logo_compression_images.png").zoom(2).subsample(17)
